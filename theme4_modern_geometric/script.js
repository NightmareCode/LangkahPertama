document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('guest-name').textContent = guestName.toUpperCase();
    ...
    openBtn.addEventListener('click', () => {
        ...
        setTimeout(() => {
            const elements = document.querySelectorAll('.slide-up-fast, .slide-left-fast, .slide-right-fast, .reveal-strip');
    ...
    if (isPreview) {
        ...
        mainContent.classList.remove('hidden');
        setTimeout(() => {
            const elementsToAnimate = document.querySelectorAll('.slide-up-fast, .slide-left-fast, .slide-right-fast, .reveal-strip');
    ...
    // --- Intersection Observer (Reveal Strips & Slides) ---
