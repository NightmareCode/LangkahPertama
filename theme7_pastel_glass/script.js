document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- 4. Scroll Animations ---
    const animatedElements = document.querySelectorAll(".float-up");
    
    // Custom logic for hero-text to ensure proper centering when floated up
    ...
    }, { threshold: 0.1, rootMargin: "0px 0px -50px 0px" }); // trigger slightly before it appears
    ...
    const timerInterval = setInterval(() => {
        ...
        if (distance < 0) {
            ...
            document.querySelector(".countdown-glass").innerHTML = "<div class='c-box w-full text-center span-full' style='font-family:var(--font-serif); font-size:24px; color:var(--primary);'>Hari Bahagia Tiada Penghujung</div>";
            return;
        }
